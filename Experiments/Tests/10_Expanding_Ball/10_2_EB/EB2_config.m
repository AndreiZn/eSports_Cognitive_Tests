function [CFG] = EB2_config(CFG, test_idx)

CFG.tests{test_idx}.long_name = '2-ExpandBall_Tar_Con_Speed_NCon';
...
CFG.tests{test_idx}.test_instructions = ...
    ...
    'Instruction: click when inner circle is closest to outer circle (2)', 'You should focus on the center of the screen', 'Click to start the experiment.'};